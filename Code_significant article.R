...
figure1 <- ggplot(
  ...
  labs(
    title = "Cultivated and non-cultivated plant observations",
    subtitle = "iNaturalist plant records from the University of Auckland City Campus",
    x = NULL,
...
figure2 <- ggplot(
  ...
  coord_flip() +
  labs(
    title = "Top 15 plant taxa in iNaturalist records from the University of Auckland City Campus",
    x = NULL,
    y = "Number of observations",
...
figure3 <- ggplot(
  ...
  geom_col(width = 0.7) +
  labs(
    title = "Monthly iNaturalist plant records from the University of Auckland City Campus",
    x = "Month",
    y = "Number of observations"
    ) +
...
figure4 <- ggplot(
  ...
  geom_col(width = 0.75) +
  labs(
    title = "Yearly iNaturalist plant records from the University of Auckland City Campus",
    x = "Year",
    y = "Number of observations"
    ) +
  scale_x_continuous(
